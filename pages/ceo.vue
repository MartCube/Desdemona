	...
	<div class="page">
		<div class="wrap">
			...
			<div class="text">
				...
				<h1>Desdemona</h1>
				<h2>Capital</h2>
				<span>The investment arm of Christian Jagodzinski</span>
		...
		<div class="wrap reverse">
			...
			<div class="text">
				<p>While the Internet gold rush is typically recognized as beginning in 1995, the beginnings of Christian and Michael’s company date back as early of 1985. For this reason, when the mainstream popularity of the Internet finally broke
					...
					stock-swap.</p>
				<p>Christian stayed on as an Amazon executive for about a year, but being a cog in the wheel of a multi-national company like Amazon didn’t present him with the challenge he had been used to. He left Amazon to travel the globe in
					luxury and take a much-deserved break from the fast-paced world of building up and running a successful business.</p>
			</div>
		</div>
		<div class="wrap">
			<div class="text">
